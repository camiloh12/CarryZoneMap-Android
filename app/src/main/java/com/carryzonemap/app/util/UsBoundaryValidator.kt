...
object UsBoundaryValidator {
     ...
     */
    private fun isPointInUsBoundary(
        latitude: Double,
        longitude: Double,
    ): Boolean {
    ...
    /**
     * Checks if a point is inside a polygon, considering holes.
     * Returns true if the point is in the exterior ring and not in any holes.
     */
    private fun isPointInPolygonWithHoles(
        point: Point,
        ...
        return !isPointInAnyHole(point, polygon)
    }

    /**
     * Checks if a point is inside any of the polygon's holes.
     */
    private fun isPointInAnyHole(
        point: Point,
        polygon: List<List<Point>>,
    ): Boolean {
     ...
     */
    internal val US_STATE_BOUNDING_BOXES =
        listOf(
